...
/**
 * <p>
 *  Abstract Implementation of an {@link ExecutorService} that uses either the
 *  Synchronous or Asynchronous Bukkit ExecutorService
 * </p>
 */
public abstract class AbstractBukkitExecutor implements ExecutorService {
    ...
    /**
     * @param plugin The {@link Plugin} that is passed onto the {@link BukkitScheduler}
     */
    ...
    /**
     * Submits the Task to the Executor delayed by the specified amount of ticks
