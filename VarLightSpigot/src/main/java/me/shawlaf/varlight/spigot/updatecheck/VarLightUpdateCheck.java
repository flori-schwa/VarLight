package me.shawlaf.varlight.spigot.updatecheck;
...
public class VarLightUpdateCheck implements Runnable {
    ...
    public VarLightUpdateCheck(Logger logger, NumericMajorMinorVersion currentVersion) {
